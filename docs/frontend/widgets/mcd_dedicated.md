...
![reboot_report](../images/widgets/reboot_report.png)

## IT Groups List

Shows a graphic grid of all infrastructure Groups, sorted by name, representing their own status.

![groups_status_grid](../images/widgets/groups_status_grid.png)
...
![subset_groups_status](../images/widgets/subset_groups_status.png)

## Active Downtimes

Shows the active downtimes of selected enity type.

![entity_active_downtimes](../images/widgets/entity_active_downtimes.png)

## Next Active Downtimes

Shows the downtimes of selected entity type that will be active in the future.

![entity_next_active_downtimes](../images/widgets/entity_next_active_downtimes.png)

# More dedicated widget groups

1. [Massive Reboot](mcd_reboot.md)
2. [Rebuild VM](mcd_rebuild_vm.md)
3. [Massive Downtime](mcd_downtime.md)
